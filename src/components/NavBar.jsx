...
const NavBar = () => {
  ...
  return (
    <>
      <div className="flex pt-8 px-6 hover:bg-white text-white hover:text-black">
        <nav className="flex-1">

          <a className="block md:hidden" onClick={openDrawerLeft}><HiMiniBars3 /></a>

          <ul className="hidden md:flex gap-4">
            <li><div className="border-b-2 border-transparent hover:border-b-black pb-8"><a >MEN<IoChevronDownSharp className="inline" /></a></div></li>
            <li><div className="border-b-2 border-transparent hover:border-b-black pb-8"><a>WOMEN<IoChevronDownSharp className="inline" /></a></div></li>
            <li><a>ABOUT</a></li>
          </ul>
        </nav>
        <div className="flex-1 flex justify-center h-full">
          <h2 className="store-title"><a href="/" title="Thursday Boot Company">
            <svg className='h-32' xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 2048 787" width="1280" height="1280">
