...
const NavBar = () => {
  ...
  return (
    <>
      <div className="flex px-6 bg-white md:bg-transparent hover:bg-white text-black md:text-white hover:text-black w-full h-16"> {/**Added h-16 */}
        ...
        <div className="flex-1 flex justify-center h-full">
          <h2 className="store-title"><a href="/" title="Thursday Boot Company">
            <svg className='md:h-[6rem] hover:h-full h-full w-full md:w-[15rem] py-2' xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 2048 787" width="667" height="418" >
